...
extension DKContainer: DockerItemSortConforming {
    static func objectBiggerInSize(
        lhs container: DKContainer, rhs container2: DKContainer, context model: VmViewModel
    ) -> Bool {
...
extension DKVolume: DockerItemSortConforming {
    static func objectBiggerInSize(
        lhs image: DKVolume, rhs image2: DKVolume, context model: VmViewModel
    ) -> Bool {
...
extension DKSummaryAndFullImage: DockerItemSortConforming {
    static func objectBiggerInSize(
        lhs image: DKSummaryAndFullImage, rhs image2: DKSummaryAndFullImage, context: VmViewModel
    ) -> Bool {

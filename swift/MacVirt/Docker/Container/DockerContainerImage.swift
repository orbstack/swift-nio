...
private func getImage(for container: DKContainer) -> String? {
    ...
    // strip version tag
    let rawImage = container.image
    guard let image = rawImage.split(separator: ":").first else {
        return nil
    }

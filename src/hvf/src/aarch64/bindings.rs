...
fn bindgen_test_layout_hv_vcpu_exit_exception_t() {
    const UNINIT: ::std::mem::MaybeUninit<hv_vcpu_exit_exception_t> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).virtual_address) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(hv_vcpu_exit_exception_t),
...
fn bindgen_test_layout_hv_vcpu_exit_t() {
    const UNINIT: ::std::mem::MaybeUninit<hv_vcpu_exit_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(

...
pub enum Error {
    ...
    #[error("vm allocate")]
    VmAllocate,
    #[error("Intel CPUs older than Skylake (6th generation) or newer than Ice Lake (10th generation), the newest CPU ever shipped in an Intel Mac, are not supported. Downgrade to OrbStack v1.5.1 or older at your own risk: https://orbsta.cc/intel-gen5-downgrade")]
    CpuUnsupported,
}

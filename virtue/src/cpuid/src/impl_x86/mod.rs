...
mod common;
use crate::impl_x86::common::*;

/// Contains helper methods for bit operations.
pub mod bit_helper;

mod template;
pub use crate::impl_x86::template::c3;
pub use crate::impl_x86::template::t2;
...
mod transformer;
use crate::impl_x86::transformer::*;
pub use crate::impl_x86::transformer::{Error, VmSpec};

mod model;
use crate::impl_x86::model::CpuId;

mod brand_string;

pub use crate::impl_x86::transformer::intel::IntelCpuidTransformer;
pub use crate::impl_x86::transformer::CpuidTransformer;

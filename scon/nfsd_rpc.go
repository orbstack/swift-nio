...
const (
	...
	nfsExpBaseFlags = NFSEXP_INSECURE_PORT | NFSEXP_ROOTSQUASH | NFSEXP_ALLSQUASH | NFSEXP_ASYNC | NFSEXP_GATHERED_WRITES | NFSEXP_NOSUBTREECHECK | NFSEXP_FSID | NFSEXP_CROSSMOUNT

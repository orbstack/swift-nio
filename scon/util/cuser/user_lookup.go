// Taken from https://github.com/golang/go/blob/ab5c22e7ed6bda79f07410c0041e020e52dc9b35/src/os/user/lookup_unix.go
// Changes:
// - use securefs to open files
//
...
func matchGroupIndexValue(value string, idx int) lineFunc {
	...
	return func(line []byte) (v any, err error) {
		...
		return &osuser.Group{Name: parts[0], Gid: parts[2]}, nil
	}
}

func findGroupId(id string, r io.Reader) (*osuser.Group, error) {
	if v, err := readColonFile(r, matchGroupIndexValue(id, 2), 3); err != nil {
		return nil, err
	} else if v != nil {
		return v.(*osuser.Group), nil
	}
	return nil, osuser.UnknownGroupIdError(id)
}

func findGroupName(name string, r io.Reader) (*osuser.Group, error) {
...
func findUserId(uid string, r io.Reader) (*osuser.User, error) {
	...
	if v, err := readColonFile(r, matchUserIndexValue(uid, 2), 6); err != nil {
		...
		return v.(*osuser.User), nil
	}
	return nil, osuser.UnknownUserIdError(i)
}

func findUsername(name string, r io.Reader) (*osuser.User, error) {
...
// kept from original file in case we ever need them

/* func lookupGroup(groupname string) (*osuser.Group, error) {
...
func LookupUser(username string, fs *securefs.FS) (*osuser.User, error) {
...
/* func lookupUserId(uid string) (*osuser.User, error) {

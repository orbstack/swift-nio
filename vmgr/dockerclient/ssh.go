...
func NewCommandConn(_ context.Context, cmd string, args ...string) (net.Conn, error) {
	var (
		c   commandConn
		err error
	)
...
// https://github.com/docker/cli/blob/dac7319f10d7cc22bc9e031dd930114e4b3d5111/cli/connhelper/ssh/ssh.go#L44
type Spec struct {
	User string
	Host string
	Port string
...
// https://github.com/docker/cli/blob/dac7319f10d7cc22bc9e031dd930114e4b3d5111/cli/connhelper/ssh/ssh.go#L11
func ParseSshURL(daemonURL string) (*Spec, error) {
